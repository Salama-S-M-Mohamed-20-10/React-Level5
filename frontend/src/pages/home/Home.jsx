      ...
      {recievedDataFromApi.map((item) => {
        return(
          ...
          <CardActions sx={{ justifyContent: "space-between" }} disableSpacing>
            ...
            <Button sx={{textTransform: "capitalize", p: 1, lineHeight:1.1}} variant="contained" color="primary">
                 Add to cart
            </Button>

            <Typography mr={1} variant="body1" color={theme.palette.error.light}>$100</Typography>
